...
router.post('/drafts', auth, requireRole(ROLES.SELLER, ROLES.BUYER, ROLES.MEDIATOR), createDraftValidator, validate, propertyController.createDraft);
...
router.post('/:id/submit', auth, requireRole(ROLES.SELLER, ROLES.BUYER, ROLES.MEDIATOR), idParamValidator, validate, propertyController.submit);
